...
def do_examples(p_cls=True):
    """A collection of implementation examples for MySqlMobileTest.

    A collection of implementation examples for MySqlMobileTest. The examples
...
def do_example1(p_cls=True):
    """A working example of the implementation of MySqlMobileTest.
    ...
    t_mysqlmobiletest = MySqlMobileTest(_PROJ_NAME)
    t_mysqlmobiletest.method_1("This is do_example1")
    archiver.print_footer()
    return success


def do_example2(p_cls=True):
    """Another working example of the implementation of MySqlMobileTest.
    ...
    archiver.print_header(p_cls=p_cls)
    t_mysqlmobiletest = MySqlMobileTest(_PROJ_NAME)
    t_mysqlmobiletest.method_1("This is do_example2")
    archiver.print_footer()
    return success
